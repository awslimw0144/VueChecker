...
public class NAC_TestMetaLanguage {
    private String sTestID;
    private String sMetaLanguage;
    ...
    public void setUpData(){
        ...
        this.sMetaLanguage = nacDataBase.getValue("Dataset",this.sTestID,"metadata.language");
    }
    ...
    @Test
    public void user_Should_Be_Able_To_See_The_Matched_Language(){
        ...
        then(userTaiger).should(
                seeThat("the content retrieved from response is ", VerifyAPIReponse.responseMetaLanguage(this.sTestID),equalTo(this.sMetaLanguage))
        );
    }
}