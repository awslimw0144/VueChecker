...
public class NAC_TestMetaLocation {
    private String sTestID;
    private String sMetaLocation;
    ...
    public void setUpData(){
        ...
        this.sMetaLocation = nacDataBase.getValue("Dataset",this.sTestID,"metadata.location");
    }
    ...
    @Test
    public void user_Should_Be_Able_To_See_The_Matched_Location(){
        ...
        then(userTaiger).should(
                seeThat("the content retrieved from response is ", VerifyAPIReponse.responseMetaLocation(this.sTestID),equalTo(this.sMetaLocation))
        );
    }
}