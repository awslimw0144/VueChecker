...
public class NAC_TestMetaPrice {
    private String sTestID;
    private String sMetaPrice;
    ...
    public void setUpData(){
        ...
        this.sMetaPrice = nacDataBase.getValue("Dataset",this.sTestID,"metadata.price");
    }
    ...
    @Test
    public void user_Should_Be_Able_To_See_The_Matched_Price(){
        ...
        then(userTaiger).should(
                seeThat("the content retrieved from response is ", VerifyAPIReponse.responseMetaPrice(this.sTestID),equalTo(this.sMetaPrice.replace("\n","")))
        );
    }
}